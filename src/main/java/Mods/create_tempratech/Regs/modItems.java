...
public class modItems {
    ...
    public static final DeferredItem<BlockItem> REINFORCED_PIPE_ITEM
            = ITEMS.registerSimpleBlockItem("reinforced_pipe", modBlocks.REINFORCED_PIPE);

    public static final DeferredItem<BlockItem> ELECTROMAGNETIC_PIPE_ITEM
            = ITEMS.registerSimpleBlockItem(
            "electromagnetic_pipe",
            modBlocks.ELECTRO_MAGNETIC_PIPE
    );

    public static final DeferredItem<BlockItem> ACTIVE_LIQUID_VENT_ITEM
            = ITEMS.registerSimpleBlockItem(
            "active_vent",
            modBlocks.ACTIVE_VENT
    );
