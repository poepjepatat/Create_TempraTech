...
public class MoltenCoal extends FlowingFluid{
    @Override
    public FlowingFluid getFlowing() {
        return modFluids.FLOWING_MOLTEN_COAL.get();
    }

    @Override
    public FlowingFluid getSource() {
        return modFluids.MOLTEN_COAL.get();
    }
    ...
    public FluidType getFluidType() {
        return modFluidTypes.MOLTEN_COAL_TYPE.get();
    }
}
