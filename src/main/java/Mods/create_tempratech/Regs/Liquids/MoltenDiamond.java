...
public class MoltenDiamond extends FlowingFluid{
    @Override
    public FlowingFluid getFlowing() {
        return modFluids.FLOWING_MOLTEN_DIAMOND.get();
    }

    @Override
    public FlowingFluid getSource() {
        return modFluids.MOLTEN_DIAMOND.get();
    }
    ...
    public FluidType getFluidType() {
        return modFluidTypes.MOLTEN_DIAMOND_TYPE.get();
    }
}
